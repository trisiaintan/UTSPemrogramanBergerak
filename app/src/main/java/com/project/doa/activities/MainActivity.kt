package com.project.doa.activities
...
import com.project.doa.R
import com.project.doa.adapter.AdapterDoa
import com.project.doa.model.ModelDoa
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fabSource.setOnClickListener(View.OnClickListener {
            startActivity(Intent(Intent.ACTION_VIEW,
                    Uri.parse("https://bersamadakwah.net/doa-doa-lengkap/"))
            )
        })
